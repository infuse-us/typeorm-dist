                    ...
                    case 11:
                        ...
                        if (newColumn.isGenerated !== oldColumn.isGenerated) {
                            if (newColumn.isGenerated) {
                                upQueries.push(new Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + newColumn.name + "\" ADD GENERATED BY DEFAULT AS IDENTITY"));
                                downQueries.push(new Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + newColumn.name + "\" DROP IDENTITY IF EXISTS"));
                            }
                            else {
                                upQueries.push(new Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + newColumn.name + "\" DROP IDENTITY IF EXISTS"));
                                downQueries.push(new Query("ALTER TABLE " + this.escapePath(table) + " ALTER COLUMN \"" + newColumn.name + "\" ADD GENERATED BY DEFAULT AS IDENTITY"));
                            }
                        }
